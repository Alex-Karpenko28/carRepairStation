...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { DetailsController } from './detail/detailsController';
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { OrdersController } from './order/ordersController';
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { OrderPaymentController } from './orderPayment/orderPaymentController';
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        ...
        app.get('/details/:detailId',
            ...
            function DetailsController_getDetail(request: any, response: any, next: any) {
            const args = {
        ...
        app.post('/details',
            ...
            function DetailsController_createDetail(request: any, response: any, next: any) {
            const args = {
            ...
            try {
              ...
              const promise = controller.createDetail.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.put('/details/:detailId',
            ...
            function DetailsController_updateDetail(request: any, response: any, next: any) {
            const args = {
                    detailId: {"in":"path","name":"detailId","required":true,"dataType":"double"},
                    body: {"in":"body","name":"body","required":true,"ref":"CreateDetailDto"},
            };
            ...
            try {
              ...
              const promise = controller.updateDetail.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.delete('/details/:detailId',
            ...
            function DetailsController_deleteDetail(request: any, response: any, next: any) {
            const args = {
                    detailId: {"in":"path","name":"detailId","required":true,"dataType":"double"},
            };
            ...
            try {
              ...
              const promise = controller.deleteDetail.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.get('/orders/:orderId',
            ...
            function OrdersController_getOrder(request: any, response: any, next: any) {
            const args = {
        ...
        app.put('/orders/:orderId',
            ...
            function OrdersController_updateOrder(request: any, response: any, next: any) {
            const args = {
                    orderId: {"in":"path","name":"orderId","required":true,"dataType":"double"},
                    body: {"in":"body","name":"body","required":true,"ref":"CreateOrderDto"},
            };
        ...
        app.delete('/orders/:orderId',
            ...
            function OrdersController_deleteOrder(request: any, response: any, next: any) {
            const args = {
                    orderId: {"in":"path","name":"orderId","required":true,"dataType":"double"},
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/orderPayment',
            authenticateMiddleware([{"barearAuth":["admin"]}]),
            ...(fetchMiddlewares<RequestHandler>(OrderPaymentController)),
            ...(fetchMiddlewares<RequestHandler>(OrderPaymentController.prototype.getAllPayment)),

            function OrderPaymentController_getAllPayment(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
              ...
              const promise = controller.getAllPayment.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/orderPayment/:orderPaymentId',
            authenticateMiddleware([{"barearAuth":["admin","client"]}]),
            ...(fetchMiddlewares<RequestHandler>(OrderPaymentController)),
            ...(fetchMiddlewares<RequestHandler>(OrderPaymentController.prototype.getOrderPayment)),

            function OrderPaymentController_getOrderPayment(request: any, response: any, next: any) {
            const args = {
            ...
            try {
              ...
              const promise = controller.getOrderPayment.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/orderPayment',
            authenticateMiddleware([{"barearAuth":["admin"]}]),
            ...(fetchMiddlewares<RequestHandler>(OrderPaymentController)),
            ...(fetchMiddlewares<RequestHandler>(OrderPaymentController.prototype.createOrderPayment)),

            function OrderPaymentController_createOrderPayment(request: any, response: any, next: any) {
            const args = {
            ...
            try {
              ...
              const promise = controller.createOrderPayment.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.put('/orderPayment/:orderPaymentId',
            authenticateMiddleware([{"barearAuth":["admin"]}]),
            ...(fetchMiddlewares<RequestHandler>(OrderPaymentController)),
            ...(fetchMiddlewares<RequestHandler>(OrderPaymentController.prototype.updateOrderPayment)),

            function OrderPaymentController_updateOrderPayment(request: any, response: any, next: any) {
            const args = {
                    orderPaymentId: {"in":"path","name":"orderPaymentId","required":true,"dataType":"double"},
            ...
            try {
              ...
              const promise = controller.updateOrderPayment.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.get('/users/get/me',
            authenticateMiddleware([{"barearAuth":["client"]}]),
            ...(fetchMiddlewares<RequestHandler>(UsersController)),
            ...(fetchMiddlewares<RequestHandler>(UsersController.prototype.getMyUser)),

            function UsersController_getMyUser(request: any, response: any, next: any) {
            const args = {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.put('/users/get/me',
            authenticateMiddleware([{"barearAuth":["client"]}]),
            ...(fetchMiddlewares<RequestHandler>(UsersController)),
            ...(fetchMiddlewares<RequestHandler>(UsersController.prototype.updateMyUser)),

            function UsersController_updateMyUser(request: any, response: any, next: any) {
            const args = {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.delete('/users/get/me',
            authenticateMiddleware([{"barearAuth":["client"]}]),
            ...(fetchMiddlewares<RequestHandler>(UsersController)),
            ...(fetchMiddlewares<RequestHandler>(UsersController.prototype.deleteMyUser)),

            function UsersController_deleteMyUser(request: any, response: any, next: any) {
            const args = {
                    request: {"in":"request","name":"request","required":true,"dataType":"object"},
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/users/signup-by-link/:link',
            ...(fetchMiddlewares<RequestHandler>(UsersController)),
            ...(fetchMiddlewares<RequestHandler>(UsersController.prototype.signUpByLink)),

            function UsersController_signUpByLink(request: any, response: any, next: any) {
            const args = {
            ...
            try {
              ...
              const promise = controller.signUpByLink.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.delete('/users/:userId',
            authenticateMiddleware([{"barearAuth":["admin","worker"]}]),
            ...(fetchMiddlewares<RequestHandler>(UsersController)),
            ...(fetchMiddlewares<RequestHandler>(UsersController.prototype.deleteconcreteUser)),

            function UsersController_deleteconcreteUser(request: any, response: any, next: any) {
            const args = {
                    userId: {"in":"path","name":"userId","required":true,"dataType":"double"},
            };
            ...
            try {
              ...
              const promise = controller.deleteconcreteUser.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.put('/users/:userId',
            authenticateMiddleware([{"barearAuth":["admin","worker"]}]),
            ...(fetchMiddlewares<RequestHandler>(UsersController)),
            ...(fetchMiddlewares<RequestHandler>(UsersController.prototype.updateConcreteUser)),

            function UsersController_updateConcreteUser(request: any, response: any, next: any) {
            const args = {
                    body: {"in":"body","name":"body","required":true,"ref":"UpdateUserDto"},
                    userId: {"in":"path","name":"userId","required":true,"dataType":"double"},
            };
            ...
            try {
              ...
              const promise = controller.updateConcreteUser.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
